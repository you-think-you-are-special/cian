...
const vladimirUrl = 'https://www.cian.ru/cat.php?currency=2&deal_type=rent&district%5B0%5D=20&engine_version=2&maxprice=30000&offer_type=flat&room1=1&room9=1&type=4';
...
setInterval(() =>{
    ...
    parser
        ...
        .then(res =>{
            ...
            return P.map(res, flat =>{
                return slack.notifyVladimir(flat);
            }, {concurrency: 10})
                .then(() =>{
                    console.log('finish')
                })
